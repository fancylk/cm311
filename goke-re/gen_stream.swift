...
func generate(codec: String, out dir: String) throws {
    let width = 1280, height = 720, fps = 30, nFrames = 90
...
try generate(codec: "h264", out: dir)
try generate(codec: "hevc", out: dir)
